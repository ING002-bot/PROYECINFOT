...
<head>
    ...
    <!-- Estilo personalizado para el formulario de pago -->
...
<body>
    ...
    <div class="form-wrapper">
        <form action="procesar_pago.php" method="POST" id="pago-formulario">
            ...
            <!-- Aquí se renderizan los botones de PayPal -->
    ...
    <script>
        paypal.Buttons({
            createOrder: function(data, actions) {
                // Obtener el precio ingresado por el usuario (valor por defecto 1.00)
            ...
            onApprove: function(data, actions) {
                ...
                return actions.order.capture().then(function(details) {
                    // Mostrar alerta al usuario confirmando el pago
                    alert('Pago completado por: ' + details.payer.name.given_name);
                    // Marcar el campo oculto para indicar que el pago se completó
                    document.getElementById('pago_completado').value = "1";
                    // Enviar el formulario para procesar el pago en el servidor
